...
def alarmEditor(screen,hh=-1,mm=-1,weekRepeat=None):
  ...
  label0=M5Label("Set the hours:", x=10, y=12, color=0x226577, font=FONT_MONT_14, parent=screen1)
  label1=M5Label("Set the minutes:", x=10, y=82, color=0x226577, font=FONT_MONT_14, parent=screen1)
  label2=M5Label("Choose the need to repeat:", x=10, y=152, color=0x226577, font=FONT_MONT_14, parent=screen1)
  label3=M5Label("save", x=142, y=224, color=0xd84949, font=FONT_MONT_14, parent=screen1)
  label3=M5Label("cancel", x=238, y=224, color=0xd84949, font=FONT_MONT_14, parent=screen1)
  for k in range(0,2):
    for i in range(0,7):
      tmp_val=val[k]+(i-3)
      if tmp_val<0:
